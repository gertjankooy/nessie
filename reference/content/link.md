...
> **WCAG (2.4.4 Link Purpose in Context):** the purpose of each link must be clear from the link text alone, or from the link text plus its surrounding context. See `reference/patterns/accessibility.md`.
