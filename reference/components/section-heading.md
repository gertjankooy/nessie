...
See [../fundamentals/layout.md](../fundamentals/layout.md) for the Group and SubGroup model this sits in.
...
### Motion
Expanding and collapsing use `motion.duration.default` (300ms) with `motion.ease.default`, the existing NESSIE defaults. Under reduced motion the section changes state instantly. See [../tokens/motion.md](../tokens/motion.md).
