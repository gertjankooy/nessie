...
2. Identify the **screen type** (settings, content/detail, form, list, travel-planner) — this drives surface choice (see `reference/patterns/layout.md`) and the interaction model (see `reference/patterns/interaction-models.md`; for settings/utility screens see `reference/patterns/settings-utility.md`).
